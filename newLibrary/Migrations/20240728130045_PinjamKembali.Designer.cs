...
namespace newLibrary.Migrations
{
    ...
    [Migration("20240728130045_PinjamKembali")]
    partial class PinjamKembali
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newLibrary.Models.Entities.Pengembalian", b =>
                {
                    b.Property<Guid>("Id_pengembalian")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateOnly>("tgl_sekarang")
                        .HasColumnType("date");

                    b.HasKey("Id_pengembalian");

                    b.HasIndex("Id_peminjaman");

                    b.ToTable("Pengembalians");
                });
            ...
            modelBuilder.Entity("newLibrary.Models.Entities.Pengembalian", b =>
                {
                    b.HasOne("newLibrary.Models.Entities.Peminjaman", "Peminjaman")
                        .WithMany("Pengembalians")
